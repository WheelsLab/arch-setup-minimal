...
if check_command yay; then
    retry_command 3 yay -S --noconfirm ttf-maplemono-nf-cn-unhinted ttf-iosevkaterm ttf-sarasa-gothic-nerd-fonts
elif check_command paru; then
    retry_command 3 paru -S --noconfirm ttf-maplemono-nf-cn-unhinted ttf-iosevkaterm ttf-sarasa-gothic-nerd-fonts
else
    log_error "No AUR helper (yay/paru) found"
    exit 1
fi
